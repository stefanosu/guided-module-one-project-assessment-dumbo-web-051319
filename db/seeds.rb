...
poem4_string = 'Two roads diverged in a yellow wood,
...
poem1_string = "Once upon a midnight dreary, while I pondered, weak and weary,
...
poet2 = Poet.create(name: "Nayyirah Waheed", birthdate: "03/26/1874", nationality: "American")
poet3 = Poet.create(name: "Rumi", birthdate: "09/30/1207", nationality: "Persian")
poet4 = Poet.create(name: "Robert Frost", birthdate: "30", nationality: "Egyptian")
...
poem1 = Poem.create(poet_id: poet1.id, title: "The Raven", genre:"dark", content: poem1_string)
poem2 = Poem.create(poet_id: poet2.id, title:"Ocean taken", genre: "nature", content: poem2_string)
poem3 = Poem.create(poet_id: poet3.id, title:"Sufi", genre: "mysticisim", content: poem3_string)
poem4 = Poem.create(poet_id: poet4.id, title: "The Road Not Taken", genre: "ocean", content: poem4_string)
...
user6 = User.create(name: "name", email: "email", password: "password")
