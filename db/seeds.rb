...
poem2 = Poem.create(poet_id: poet2.id, title:"The Road not taken", genre: "nature", content: poem2_string)
poem3 = Poem.create(poet_id: poet3.id, title:"Sufi", genre: "mysticisim", content: poem3_string)
poem4 = Poem.create(poet_id: poet4.id, title: "Nature", genre: "ocean", content: poem4_string)
